 ...
 * 
 * @author Hakims
 * Configures Odometer reading page. This page includes extra logic to insure
 * the users entry is greater than the previous mileage entry into the database. 
 * Because, mileages generally go up...usually...
 * 
 * Also sends all the previous user inputs to the verification page	
 */
